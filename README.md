...
Часть функционала интегрировано в LuCI и предоставляет часть функций для управления B4.

### Внимание автор данного интерфейса не причастен к проекту "BYE BYE BIG BRO (B4)", я лишь создатель маленького интерфейса
